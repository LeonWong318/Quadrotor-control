...
## Generated on : Mon Apr 29 15:54:00 2024
...
START_DIR                 = D:/Chalmers/Sp4/SSY191/BitcrazeSharedFolder/test/project2024-13group/generate_code/simulink-model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=crazyflie -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/crazyflie_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/crazyflie_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/crazyflie_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/crazyflie_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
crazyflie.obj : $(START_DIR)/crazyflie_ert_rtw/crazyflie.c
	$(CC) $(CFLAGS) -o "$@" "$<"


crazyflieModel.obj : $(START_DIR)/crazyflie_ert_rtw/crazyflieModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


crazyflie_data.obj : $(START_DIR)/crazyflie_ert_rtw/crazyflie_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
